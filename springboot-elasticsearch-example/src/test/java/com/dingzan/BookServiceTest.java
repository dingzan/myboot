...
import com.dingzan.Application;
import com.dingzan.book.model.Book;
import com.dingzan.book.service.BookService;
...
public class BookServiceTest {
    ...
    public void testFindByAuthor() {
        ...
        bookList.add(new Book("1008", "Spring Boot + MongoDB", "test", "25-FEB-2017"));
        ...
        Page<Book> byAuthor2 = bookService.findByAuthor("test", new PageRequest(0, 10));
